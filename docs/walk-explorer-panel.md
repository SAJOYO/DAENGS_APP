...
현재 탭 이름·공통 범례·기록 상세 배치는 [걸어온 길 하단 배치 #417](walk-route-reading-layout.md)를 따른다.

시간축·구간 선택·재생의 후속 디자인은 [시안 02의 3단계 #391](walk-explorer-design-v2.md)을 참고한다.

**후속 정책:** [탭 역할 분리 #390](walk-tab-responsibilities.md)에 따라 전체/관련 장면 목록과
장면 안내는 장면 탭으로 한정했다. 아래 표와 장면 목록 설명은 #383 당시의 기록이다.
