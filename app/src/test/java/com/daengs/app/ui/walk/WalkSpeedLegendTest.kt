...
class WalkSpeedLegendTest {
    ...
    @Test fun policyRefreshUpdatesVisibleScaleWithoutReopeningMap() {
        ...
        compose.onNodeWithText("0 · 느리게").assertIsDisplayed()
        compose.onNodeWithText("2+ · 빠르게").assertIsDisplayed()
        ...
        compose.onNodeWithText("4+ · 빠르게").assertIsDisplayed()
        compose.onNodeWithText("2").assertIsDisplayed()
        compose.onNodeWithText("속도 미확인").assertIsDisplayed()
