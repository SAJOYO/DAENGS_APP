...
| 속도 표시 상태·GPS 표시 안정화 | `com.daengs.app.walk.display.*` | `com.daengs.app.ui.walk.MotionSpeedometerTest`, `com.daengs.app.ui.walk.WalkSpeedometerTest`; 표시 입력·세션 소유·고정 크기 렌더링만 검증하며 실제 runtime 연결은 5차 |
