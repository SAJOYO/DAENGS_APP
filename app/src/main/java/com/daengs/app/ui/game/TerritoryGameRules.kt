...
internal val firstSeasonGameRules = listOf(
    GameRule("mark", "가까이 가서 점령해요", "미인증 20점 · 인증하면 누적 100점까지",
        "산책 중 지도에 표시된 빈 점령 위치의 20m 안에서 영역표시하면 기본 점수를 누적 20점까지 받아요. GPS 오차도 거리에 포함돼요.\n\n점령 위치의 10m 안에서 강아지가 보이게 새 사진을 촬영해 인증하면 누적 100점까지 남은 점수를 받아요. 위치는 GPS로, 강아지 여부는 사진으로 확인해요. 20점을 받았다면 인증으로 80점을 더 받아요.\n\n한 장소의 기본 점수 한도는 회원·시즌별 100점이에요. 강아지를 바꿔도 한도는 같고, 받은 점수는 행동한 강아지에게 쌓여요."),
